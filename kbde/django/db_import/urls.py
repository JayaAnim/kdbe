...
urlpatterns = [
    ...
    path("file/<int:import_file_pk>/row/", views.ImportRowList.as_view(), name="row_list"),
    ...
    path("mapping/<int:import_mapping_pk>/mapping_column/", views.ImportMappingColumnList.as_view(), name="mapping_column_list"),
    path("mapping/<int:import_mapping_pk>/mapping_column/create", views.ImportMappingColumnCreate.as_view(), name="mapping_column_create"),
    path("mapping/<int:import_mapping_pk>/mapping_row/", views.ImportMappingRowList.as_view(), name="mapping_row_list"),
